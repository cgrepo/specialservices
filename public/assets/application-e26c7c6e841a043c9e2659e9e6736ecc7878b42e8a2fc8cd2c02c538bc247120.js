...
(function() {
  var caseUIEnabled, fillCase, fillExp, getExpeditureIDs, otExp, personID, setup, spinner, superCell, tabsEnabled, validCaseData, validExpensivesData;
  ...
  getExpeditureIDs = function() {
    return $('#otherExpedituresTable tbody tr').each(function() {
      return console.log($(this).find('td last').text());
    });
  };
