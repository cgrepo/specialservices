...
(function() {
  var checkRows, fillR, fillRE, fillREL, personDataGet, personDataUX, personID, prevPic, relative, relativeData, requester, responsable, responsableDataGet, responsableDataUX, responsableID, setup, spinner, tabsEnabled;
  ...
  $(document).on("turbolinks:load", function() {
    ...
    setup();
    $('a#save-person').on('click', function() {
      spinner('ON');
      personDataGet();
      return $.ajax({
        type: 'POST',
        ...
        success: function(data) {
          ...
          spinner('OFF');
          $('.badge').text('1');
          return $('a#edit-person').attr('disabled', false);
        },
        error: function(data) {
          alert(data);
          return spinner('OFF');
    ...
    $('a#edit-person').on('click', function() {
      ...
      return $('a#edit-person').fadeToggle('slow');
    });
    $('a#update-person').on('click', function() {
      ...
      return $.ajax({
        ...
        success: function(data) {
          ...
          return $('a#update-person').fadeToggle('slow');
        },
        error: function(data) {
          alert(data);
          return spinner('OFF');
    ...
    $('a#save_relatives').on('click', function() {
      relative = [];
  ...
  setup = function() {
    ...
    return $('a#update-responsable').hide();
  };
  ...
  personDataGet = function() {
    ...
    return requester.push($('#person_picture').val());
  };
