...
(function() {
  var checkRows, fillR, personID, tabsEnabled;
  ...
  $(document).on("turbolinks:load", function() {
    ...
    $('a#save-person').on('click', function() {
      ...
      return $.ajax({
        ...
        success: function(data) {
          ...
          $('#save_person').attr('disabled', true);
          $.each(data, function(element, value) {
            return personID = value;
          });
          tabsEnabled(true);
          return console.log(personID);
        },
        error: function(data) {
          return alert(data);
        }
    ...
    $('a#save-responsable').on('click', function() {
      ...
      responsable.push($('responsable_work_place').val());
      ...
      return $.ajax({
        ...
        success: function(data) {
          ...
          return console.log('person=' + personID + 'responsable=' + responsableID);
        },
        error: function(data) {
          return alert(data);
        }
  ...
  tabsEnabled = function(opt) {
    if (opt) {
      ...
      return $('.nav li#relative').find('a').attr("data-toggle", "tab");
    } else {
