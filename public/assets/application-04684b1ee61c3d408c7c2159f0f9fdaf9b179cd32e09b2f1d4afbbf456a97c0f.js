...
(function() {
  var checkRows, fillR, fillRE, fillREL, personDataGet, personDataUX, personID, requester, responsableID, spinner, tabsEnabled;
  ...
  $(document).on("turbolinks:load", function() {
    ...
    return $('a#save_relatives').on('click', function() {
      return alert('dudes will be saves without person will put you back to fill this data :)');
    });
  });
