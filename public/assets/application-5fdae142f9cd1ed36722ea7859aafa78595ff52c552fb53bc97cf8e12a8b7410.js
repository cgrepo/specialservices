...
(function() {
  var checkRows, fillR, fillRE, fillREL, personDataGet, personDataUX, personID, relative, requester, responsable, responsableDataGet, responsableDataUX, responsableID, setup, spinner, tabsEnabled;
  ...
  $(document).on("turbolinks:load", function() {
    ...
    return $('a#save_relatives').on('click', function() {
      return $('#relationshipTable tbody tr').each(function() {
