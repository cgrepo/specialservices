...
(function() {
  var checkRows, fillR, fillRE, fillREL, personDataGet, personDataUX, personID, relative, relativeData, requester, responsable, responsableDataGet, responsableDataUX, responsableID, setup, spinner, tabsEnabled;
  ...
  $(document).on("turbolinks:load", function() {
    ...
    return $('a#save_relatives').on('click', function() {
      relative = [];
...
(function() {
  var caseUIEnabled, fillCase, fillExp, getBenefitsIDs, getExpeditureIDs, getServicesIDs, otExp, personID, setup, spinner, superCell, tabsEnabled, validCaseData, validExpensivesData, validLivingData;
  ...
  getExpeditureIDs = function() {
    return $('#otherExpedituresTable tbody tr').each(function() {
      return console.log('getting other expeditures ' + $(this).find('td').eq(3).text());
    });
  };

  getBenefitsIDs = function() {
    return $('#benefitsTable tbody tr').each(function() {
      return console.log('getting other benetits ' + $(this).find('td').eq(3).text());
    });
  };

  getServicesIDs = function() {
    return $('#servicesTable tbody tr').each(function() {
      return console.log('getting other services ' + $(this).find('td').eq(2).text());
    });
  };
